        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h2 class="box-title ">ব্যাক্তিগত তথ্য</h2>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-inline">
                                ...
                                <div class="form-group col-sm-3">
                                    <label>ওয়ার্ড</label>
                                    <select class="form-control "  style="width: 100%;"ng-model="memberSurveyInfo.mWordId" ng-init="setPostList('<?php echo htmlspecialchars(json_encode($post_list)) ?>')">
                                        <option value="">..Select..</option>
                                        <option ng-repeat="postInfo in postList" value={{postInfo.id}} >{{postInfo.name}}</option>
                                    </select>
                                </div>
