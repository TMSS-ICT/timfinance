...
CREATE TABLE IF NOT EXISTS `member_addresses` (
  ...
  `p_country_id` int(11) unsigned DEFAULT NULL,
   PRIMARY KEY  (`id`),
  UNIQUE KEY `uc_member_basic_info` (`member_id`,`nid`),
  KEY `fk_member_basic_info_member_in_idx` (`member_id`),
  KEY `fk_member_basic_info__nid_idx` (`nid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;   
...
CREATE TABLE IF NOT EXISTS `member_family_info` (
  ...
  `m_age` varchar(40) DEFAULT NULL,
   PRIMARY KEY  (`id`),
  UNIQUE KEY `uc_member_family_info` (`member_id`,`nid`),
  KEY `fk_member_basic_family_member_idx` (`member_id`),
  KEY `fk_member_basic_family_nid_idx` (`nid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;   
...
CREATE TABLE IF NOT EXISTS `member_profession_info` (
  ...
  `alt_earning_source` varchar(20) DEFAULT NULL,
    PRIMARY KEY  (`id`),
  UNIQUE KEY `uc_member_profession_info` (`member_id`,`nid`),
  KEY `fk_member_basic_profession_member_id_idx` (`member_id`),
  KEY `fk_member_basic_profession__nid_idx` (`nid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;  
...
CREATE TABLE IF NOT EXISTS `member_land_info` (
  ...
  `amount` varchar(20) DEFAULT NULL,
  PRIMARY KEY  (`id`),
  UNIQUE KEY `uc_member_land_info` (`member_id`,`nid`),
  KEY `fk_member_basic_land__id_idx` (`member_id`),
  KEY `fk_member_basic_land_nid_idx` (`nid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;   
...
`total_member` varchar(20) DEFAULT NULL
  PRIMARY KEY  (`id`),
  UNIQUE KEY `uc_member_business_info` (`member_id`,`nid`),
  KEY `fk_member_business_info_member_id_idx` (`member_id`),
  KEY `fk_member_business_info_nid_idx` (`nid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1; 
